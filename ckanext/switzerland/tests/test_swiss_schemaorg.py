...
def test_basic_fields_map_fluent_description():
    ...
    assert ("de", "DE text") in triples
    assert ("fr", "FR texte") in triples
...
def test_basic_fields_map_fluent_title():
    ...
    assert ("de", "Titel") in triples
    assert ("it", "Titolo") in triples


def test_empty_description_dict_emits_no_description_triples():
...
def test_distribution_basic_fields_multilang_name_and_description():
    ...
    assert ("de", "Ressource") in names
    assert ("fr", "Ressource FR") in names
