...
@patch('ckanext.switzerland.harvester.timetable_harvester.FTPStorageAdapter', MockFTPStorageAdapter)
...
class TestTimetableHarvester(BaseSBBHarvesterTests):
    ...
    def test_simple(self):
        MockFTPStorageAdapter.filesystem = self.get_filesystem(filename='FP2016_Jahresfahrplan.zip')
