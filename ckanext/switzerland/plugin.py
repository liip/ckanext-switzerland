...
class OgdchPackagePlugin(OgdchLanguagePlugin):
    ...
    def before_dataset_index(self, search_data):
        ...
        # This is necessary as of this update to CKAN: https://github.com/ckan/ckan/commit/e1dde691fd12283209ccea39592c31e7013b25be#diff-4f2653bfd681793bf0b7ea57d10cefb6bcdf489bbd65dd71a8acb38e1f49854bR625
        ...
        for key in ["publishers", "contact_points", "relations", "temporals", "keywords", "language", "display_name", ]:
            search_data[key] = json.dumps(search_data.get(key, []))

        search_data["res_description"] = [json.dumps(description) for description in search_data["res_description"]]
